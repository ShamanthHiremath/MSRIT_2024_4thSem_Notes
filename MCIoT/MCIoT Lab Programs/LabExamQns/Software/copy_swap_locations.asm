...
__main 	
	...
	LDR r2,=10          ; n = number of bytes to copy
copy_loop
	LDRB r3, [r0]   ; read 1 byte from r0
	LDRB r4, [r1]   ; read 1 byte from r1
	STRB r3, [r1]   ; write 1 byte from r3
	STRB r4, [r0]   ; write 1 byte from r4
