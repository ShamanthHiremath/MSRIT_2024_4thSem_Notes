...
main(int argc, char* argv[])
{
    ...
    ApplicationContainer sinkApp = packetSinkHelper.Install(csmaNodes.Get(2));  //change sink
    ...
    InetSocketAddress rmt(csmaInterfaces.GetAddress(nCsma), port);  //change interfaces
    rmt.SetTos(0xb8);
    AddressValue remoteAddress(rmt);
    onoff.SetAttribute("Remote", remoteAddress);
    apps.Add(onoff.Install(wifiStaNodes.Get(0)));                //change source
