...
main(int argc, char* argv[])
{
    ...
    // 5. Make devices-> devices23
    //    Make Install(nodes) -> Install(nodes.Get(2), nodes.Get(3))
...
*/
    ...
    // 7. Make address-> address01 , interfaces -> interfaces01 , devices -> devices01
    ...
    // 8.  Copy above three lines and Change address,  Source IP address , devices and interfaces
    ...
    // 9.  Copy above three lines and Change address,  Source IP address , devices and interfaces
    ...
    // 10.  Examples->tutorials->third.cc->line 173 (Copy below line from there)
    ...
    //11. Make sink app 0 to 3(that is your last node)
